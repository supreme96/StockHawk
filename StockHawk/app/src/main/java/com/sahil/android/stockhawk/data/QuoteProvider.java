package com.sahil.android.stockhawk.data;
...
/**
 * Created by sahil on 10/5/15.
 */
@ContentProvider(authority = QuoteProvider.AUTHORITY, database = QuoteDatabase.class)
public class QuoteProvider {
  public static final String AUTHORITY = "com.sahil.android.stockhawk.data.QuoteProvider";
